...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-[125vh] bg-[#F8F9FA] text-[#191c1d] font-sans relative overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none" style={{ background: `radial-gradient(circle at 10% 50%, rgba(2, 251, 255, 0.35) 0%, transparent 60%), radial-gradient(circle at 70% 20%, rgba(253, 139, 0, 0.20) 0%, transparent 60%)` }} />
